...
public class CustomRefreshListView extends ListView implements AbsListView.OnScrollListener{
    ...
    private void initFooterView() {
        ...
        fProgressBar = (ProgressBar) footerView.findViewById(R.id.list_footer_pb);
        fText = (TextView) footerView.findViewById(R.id.list_footer_txt);
    ...
    private void initHeaderView() {
        ...
        ivArrow = (ImageView) headerView
                .findViewById(R.id.list_header_arrow);
        mProgressBar = (ProgressBar) headerView
                .findViewById(R.id.list_header_pb);
        tvState = (TextView) headerView
                .findViewById(R.id.list_header_state);
    ...
    public void noData(Boolean b){
        if (b){
            fProgressBar.setVisibility(GONE);
            fText.setText("已無資料加載");
        }else{
            fProgressBar.setVisibility(VISIBLE);
            fText.setText("加載更多...");
        }
    }
}
