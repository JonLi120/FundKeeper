...
public class CircleFlowIndicator extends View implements FlowIndicator, AnimationListener {
	...
	public CircleFlowIndicator(Context context) {
		super(context);
		initColors(0x00CC00, 0x66FF99, STYLE_FILL, STYLE_STROKE);
	}
	...
	public CircleFlowIndicator(Context context, AttributeSet attrs) {
		...
		int activeDefaultColor = 0x00CC00;
		...
		int inactiveDefaultColor = 0x66FF99;
		...
		// Retrieve the radius
		mRadius = a.getDimension(R.styleable.CircleFlowIndicator_radius, 7.0f);
		mRadiusActive = mRadius;
		mRadiusInactive = mRadius;

		// Retrieve the spacing
		spacing = a.getDimension(R.styleable.CircleFlowIndicator_spacing, 7.0f);
