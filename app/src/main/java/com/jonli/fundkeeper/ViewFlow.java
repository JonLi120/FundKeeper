...
public class ViewFlow extends AdapterView<Adapter> {
    ...
    private static final float MOVE_TOUCHSLOP = 1f; //�����˵�ƫ�ƶ���Ϊ���ƶ������ǵ��
    /**
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                Log.e("------------", "onInterceptTouchEvent ACTION_MOVE-- mTouchState:"+mTouchState);
    ...
    private class WindowRunnnable {
        ...
        public void rememberWindowAttachCount() {
            mOriginalAttachCount = getWindowAttachCount(); //getWindowAttachCount ��ȡ�ؼ����ڴ����ϵĴ���
        }

        public boolean sameWindow() {  //�ж��Ƿ���ͬһ�����ڣ��쳣���ʱ����attachWindowCount����+1����ô��ʱ�Ͳ���ͬһ�������ˡ�
    ...
    private class PerformClick extends WindowRunnnable implements Runnable {
        ...
        public void run() {
            ...
            if (adapter != null && mAdapter.getCount() > 0 &&
                ...
                //final View view = getChildAt(motionPosition - mFirstPosition); // mFirstPosition����ע
    ...
    protected void onDetachedFromWindow() {
        ...
        if (mPerformClick != null) {
            ...
            Log.e("--------", "  onDetachedFromWindow removeCallbacks(mPerformClick)");
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        ...
        switch (action) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                boolean xMoved = Math.abs(deltaX) > mTouchSlop;
                //---------add start  ����y�ƶ�ƫ���� �ж�y���Ƿ����ƶ���������down�£��Ƿ���һ��click�¼�
                ...
                boolean tempIsMoved = isXMoved || isYMoved ; //xy�е�ƫ�ƶ���Ϊ���ǵ���¼�
                mIsClick = !tempIsMoved;  //��x��yƫ��������С������Ϊ��һ��click�¼�
            ...
            case MotionEvent.ACTION_UP:
                ...
                //------------------����һ��click����ִ�е���������AbsListView ����PerformClick
                ...
                if(mIsClick){
                    ...
                    performClick.rememberWindowAttachCount(); //��¼���ʱ�����Ӵ��ڴ���
                    performClick.run();
                }
                //------------------
